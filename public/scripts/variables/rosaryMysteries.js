const rosaryMysteries = {
  joyful: {
    label: "Los Misterios Gozosos",
    mysteries: [
      {
        label: "La Anunciación",
        libro: "Lucas 1, 30-32, 38",
        description:
      ...
      {
        label: " La Visitación (de María a su prima Santa Isabel)",
        libro: "Lucas 1, 39-43",
        description:
      ...
      {
        label: "El Niño Perdido y Hallado en el Templo",
        libro: "Lc 2, 41-47",
        description:
  ...
  luminous: {
    label: "Los Misterios Luminosos",
    mysteries: [
      {
        label: "Su bautismo en el Jordán",
        libro: "Mt 3, 13, 16-17",
        description:
  ...
  sorrowful: {
    label: "Los Misterios Dolorosos",
    mysteries: [
      {
        label: "La Agonía en el Huerto",
        libro: "Lc 22, 39-46",
        description:
      ...
      {
        label: "La Flagelación de Nuestro Señor Jesucristo",
        libro: "Jn 18, 33, 19;1",
        description:
      ...
      {
        label: "La Coronación de Espinas",
        libro: "Mt 27, 29-30",
        description:
      ...
      {
        label: "La Crucifixión y Muerte de Nuestro Señor",
        libro: "Lc 23, 33-34, 44-46; Jn 19, 33-35",
        description:
  ...
  glorious: {
    ...
    mysteries: [
      {
        label: "La Resurrección del Señor",
        libro: "Mt 28, 5-6",
        description:
      ...
      {
        label: "La Asunción de la Virgen Santísima",
        libro: "Ct 2, 10-11, 14",
        description:
